          ...
          case 0:
            ...
            function () {
              ...
              _regenerator["default"].mark(function _callee6(question) {
                var questionId, roomId, correctAnswer, recipientId, recipient, completed;
                  ...
                  while (1) {
                    switch (_context6.prev = _context6.next) {
                      case 0:
                        ...
                        _context6.next = 4;
                        return Player.findById(recipientId);

                      case 4:
                        recipient = _context6.sent;
                      ...
                      case 7:
                        (0, _logger.warn)("Recipient not in game -", recipientId);
            ...
            function () {
              ...
              _regenerator["default"].mark(function _callee9(answer) {
                var _socket$player, playerId, roomId, currentQuestion, _currentQuestion, questionId, recipientId, type, options, isRecipient, answerArray, openEndedAnswer;
                  ...
                  while (1) {
                    switch (_context9.prev = _context9.next) {
                      ...
                      case 5:
                        ...
                        _currentQuestion = currentQuestion, questionId = _currentQuestion._id, recipientId = _currentQuestion.recipientId, type = _currentQuestion.type, options = _currentQuestion.options;
                      ...
                      case 16:
                        ...
                        openEndedAnswer = options.findIndex(function (option) {
                      ...
                      case 21:
                        openEndedAnswer = _context9.sent;

                      case 22:
                        _context9.next = 24;
                        return Answer.create(openEndedAnswer, questionId, playerId);
